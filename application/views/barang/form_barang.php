...
form-control-line form-user-input" name="nama_barang" id="nama_barang">
					...
					<div class="form-group">
						...
						<div class="col-md-12">
							<textarea rows="5" class="form-control form-control-line form-user-input" name="deskripsi"
								id="deskripsi" placeholder="Ceritakan barang"></textarea>
						</div>
					</div>
					<div class="form-group">
...
<script type="text/javascript">
    ...
    function sendDataPost() {
		<?php
			if ($title == 'Form Edit Data Barang') {
				echo "var link = 'http://localhost/backend_inventory_4133/barang/update_action/';";
			} else {
	...
	function getDetail(id_barang) {
		var link = 'http://localhost/backend_inventory_4133/barang/detail?id_barang='+id_barang;
