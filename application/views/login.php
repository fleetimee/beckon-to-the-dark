...
<!-- WARNING: Respond.js doesn't work if you view the page via file:// -->
    ...
    class="form-control form-control-line form-user-input" name="email" id="example-email">
    </div>
    </div>
    <div class="form-group">
    ...
    control form-control-line form-user-input">
    </div>
    </div>
    <div class="form-group">
    <div class="col-sm-12">
    ...
    function checkLogin() {
        var link = "http://localhost/backend_inventory_4133/user/check_login/";
        var dataForm = {};
    ...
    function setSession(user) {
        var link = "http://localhost/client_inventory_4133/login/setSession";
        var dataForm = {};
        ...
        $.ajax(link, {
            ...
            data: dataForm,
            success: function (data, status, xhr) {
                location.replace('http://localhost/client_inventory_4133/home');
            },
            error: function (jqXHR, textStatus, errorMsg) {
                alert('Error : ' + errorMsg);
            }
