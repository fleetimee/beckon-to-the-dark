                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent" data-navbarbg="skin5">
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src=<?= base_url('assets/images/halo.png')?> alt="user" class="rounded-circle" width="31"></a>
                    ...
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="#" onclick="loadMenu('<?= base_url('barang')?>')" aria-expanded="false">
                                <i class="mdi mdi-cart-outline"></i><span class="hide-menu">Barang</span>
                            </a>
                        </li>

                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="#" onclick="loadMenu('<?= base_url('department')?>')" aria-expanded="false">
                                <i class="mdi mdi-border-all"></i><span class="hide-menu">Department</span>
                            </a>
                        </li>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="#" onclick="loadMenu('<?= base_url('peminjaman')?>')" aria-expanded="false">
                                <i class="mdi mdi-border-all"></i><span class="hide-menu">Peminjaman</span>
                            </a>
                        </li>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="#" onclick="loadMenu('<?= base_url('pengembalian')?>')" aria-expanded="false">
                                <i class="mdi mdi-border-all"></i><span class="hide-menu">Pengembalian</span>
                            </a>
                        </li>

                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="#" onclick="loadMenu('<?= base_url('laporan/tahunan')?>')" aria-expanded="false">
                                <i class="mdi mdi-chart-areaspline"></i><span class="hide-menu">Laporan Tahunan</span>
                            </a>
                        </li>

                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="#" onclick="loadMenu('<?= base_url('laporan/stok')?>')" aria-expanded="false">
                                <i class="mdi mdi-chart-bar"></i><span class="hide-menu">Laporan Stok</span>
                            </a>
                        </li>
